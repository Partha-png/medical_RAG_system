...
bashgit clone https://github.com/yourusername/medical_RAG_system.git
...
Upload a medical document (PDF or TXT format)
Select your preferred encoder model (BioBERT or MedCPT)
Click Process Document and wait for indexing to complete

Asking Questions

Switch to the Chat tab
Adjust the number of chunks to retrieve (k) using the sidebar slider
Type your medical question in the chat input
View the AI-generated answer based on your document
Expand "View Retrieved Chunks" to see source passages
